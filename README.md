...
Fresh databases are created from `01_init.sql` (mounted by `docker-compose.yml`). Existing databases are upgraded with the numbered, idempotent SQL files at the repository root, applied in order:
